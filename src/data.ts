...
export const MOSAIC = [
  { src: `${BASE}/slides/image1.jpg`,   label: "The Campus",    span: "1 / 1 / 3 / 2" },
  ...
  { src: `${BASE}/slides/image12.jpeg`, label: "Organizations", span: "2 / 3 / 3 / 4" },
];
...
// Mega-menu structure for primary navigation.
export const MENU = [
  {
...
export const QUICKLINKS = [
  { label: "Student Portal", desc: "Grades, schedules & records", to: "/campus" },
...
export const NEWS = [
  { tag: "Announcement", date: "Aug 18, 2026", title: "Admissions for A.Y. 2026–2027 now open", desc: "Applications are being accepted across all nine degree programs. Visit the admissions office to begin.", img: `${BASE}/slides/image8.jpeg` },
